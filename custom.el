...
(custom-set-variables
 ...
 '(package-selected-packages
   '(async bash-completion cape corfu crux eglot-booster forge fussy fzf
	   fzf-native gptel gruvbox-theme kdl-mode keycast orderless
	   ox-hugo rg solidity-mode undo-tree vertico))
